...
- Container 서비스팩 설치 전 Bosh 2.0 배포 주의사항
  >IaaS 환경이 OPENSTACK 인 경우 bosh deploy 시 /home/{user_name}/workspace/paasta-4.0/deployment/bosh-deployment/openstack/disable-readable-vm-names.yml 파일을 옵션으로 추가한 후 배포한다.
